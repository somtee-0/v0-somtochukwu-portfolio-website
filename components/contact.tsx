    ...
    <section id="contact" className="py-20 bg-background">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl lg:text-4xl font-bold text-center mb-4 text-balance">Get In Touch</h2>
            ...
            <div className="space-y-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">+2347037158756</p>
                      <p className="text-muted-foreground">+2347061425461</p>
                    </div>
                  </div>
              ...
              <div>
                ...
                <ul className="space-y-2 text-muted-foreground">
                  ...
                  <li>• Finance Platform Development</li>
